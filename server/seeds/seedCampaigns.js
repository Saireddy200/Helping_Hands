...
async function seedCampaigns() {
  try {
    // Connect to MongoDB
    await mongoose.connect(process.env.MONGODB_URI || 'mongodb+srv://saisrinureddy809:Sai%40123@cluster0.yn0xsqs.mongodb.net/helpinghands?retryWrites=true&w=majority', {
